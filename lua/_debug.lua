...
local init_state = { nvim_dap_init = false, vimspector_init = false }

function module.setup_vimspector()

  if not init_state.vimspector_init then
    ...
    init_state.vimspector_init = true
  end

end

function module.setup_nvim_dap()
  if not init_state.nvim_dap_init then
