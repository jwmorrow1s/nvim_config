...
local function setup_scala_lsp()
  ...
  vim_utils.lang_autocmd("nvim-metals", { "scala", "sbt", "java" }, function()
    ...
    vim.api.nvim_set_keymap('n', '<Space>crs', "<cmd>MetalsRestartServer<cr>", { silent = true, noremap = true })
    vim.api.nvim_set_keymap('n', '<Space>cib', "<cmd>MetalsImportBuild<cr>", { silent = true, noremap = true })
...
require('lspconfig')['yamlls'].setup {
  ...
  cmd = { vim.env.HOME .. '/.local/share/nvim/site/pack/packer/start/yaml-language-server/bin/yaml-language-server',
    '--stdio' },
}
